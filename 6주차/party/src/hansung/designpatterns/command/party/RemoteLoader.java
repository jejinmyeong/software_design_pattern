...
public class RemoteLoader {
	...
	public static void main(String[] args) {
		...
		LightDimUpCommand lightup = new LightDimUpCommand(light);
		LightDimDownCommand lightdown = new LightDimDownCommand(light);
		...
		remoteControl.setCommand(5, lightup , lightdown);
		...
		do {
			...
			switch (input) {
				...
				case "9":
					...
					break;
				case "10":
					System.out.println("--- Pushing Light Dim UP---");
					remoteControl.onButtonWasPushed(5);
					break;
				case "11":
					System.out.println("--- Pushing Light Dim Down---");
